...
WelcomeState.prototype.enter = function(game) {
    ...
    game.sounds.init();
    game.sounds.loadSound('shoot', 'https://sasjs.io/space/shoot.wav');
    game.sounds.loadSound('bang', 'https://sasjs.io/space/bang.wav');
    game.sounds.loadSound('explosion', 'https://sasjs.io/space/explosion.wav');
};
